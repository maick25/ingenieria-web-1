...
const misCursos = [
    {
        ...
        precio: "Gratuito",
        imagen: "images/tecnologia_educativa.jpg" // NOTA PARA MÍ: Verificar si en mi PC lleva '../images/' para que cargue
    },
    {
        id: 2,
...
const misTestimonios = [
    {
        comment: "La flexibilidad de los cursos de Educ_Tecnology me permitió aprender desarrollo frontend a mi propio ritmo.",
...
function configurarFormularios() {
    ...
    if (formModalCurso) {
        formModalCurso.addEventListener('submit', function(evento) {
            ...
            if (valido) {
                alert('¡Inscripción exitosa! Se ha habilitado tu acceso al aula digital de Educ_Tecnology.');
